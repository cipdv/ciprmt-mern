...
const AddToFinancials = () => {
    ...
    return (     
        <div style={{backgroundColor: '#FFDAB9', padding: '10px', display: 'flex',  justifyContent:'center' }}>
            <form className="ui form" onSubmit={handleAdd}>
                <div className="ui fields">
                    ...
                    <div className="ui field">
                    { type ==='Income' ? (
                        <select className="ui fluid search dropdown" placeholder="Select category" value={category} onChange={(e)=>setCategory(e.target.value)}>
                        ...
                        <select className="ui fluid search dropdown" placeholder="No category to select">
                            <option value="" disabled="disabled">No category to select</option>
                        </select>
                    )}
                    </div>
                    <div className="ui field" value={details} onChange={(e)=>setDetails(e.target.value)}>
